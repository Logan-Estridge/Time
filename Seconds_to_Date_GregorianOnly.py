...
#
# Can also use as a simple conversion calculator to determine the number of Days/Hours/Minutes in a
# given number of seconds, just ignore the "Millenium", "Century", and "Year" outputs.

seconds = int(input("Enter # of Seconds Here: "))
print('')
